import { reducer, actions, selectors } from '#/redux/modules/vikimapQueries';
...
const serviceName = 'queryParser';
const serviceFnName = 'executeQuery';
      ...
      describe('Actions', () => {
        ...
        it('getData action', () => {
          ...
          return actionThunk(dispatch, () => {}, service).then(() => {
            ...
            expect(serviceCalls[0][0]).toBe(DATA_KEY);
          });
        });
