...
import { FocusMenu, ParentMenuClickButton, Page } from 'vdkweb-tv-ui';
...
const PAGE_NAV_ID = 'clickMenuPage';
...
const TVMenuTest = ({ theme = styles }) => (
  ...
  >
    <FocusMenu
      ...
      theme={theme}
      ParentComponent={ParentMenuClickButton}
      nav={{
        id: 'clickMenu',
        parent: PAGE_NAV_ID,
        useLastFocus: true
